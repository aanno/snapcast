#!/bin/bash -x
rm snapclient.log
./bin/snapclient --rist-latency 100 --player pipewire -s 'alsa_output.pci-0000_01_00.1.hdmi-stereo' --logsink stdout --logfilter *:trace rist://192.168.10.139:1706 | tee snapclient.log
